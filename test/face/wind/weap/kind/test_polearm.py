...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("Mountain-Bracing Bolt", 4, "Level 80/90 (Rank 6)", 523, WeaponStatType.energy_recharge_perc, 27.9, 5, id="face.wind.rule: Configuring weapon - Polearm - Mountain-Bracing Bolt"),
